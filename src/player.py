...
class MineSweeperPlayer():
    ...
    def _parse_uinteger(self, input):
        try:
            ...
            print("The given element is not a valid value!")
    ...
    def _parse_str_in_valids(self, input, valids: list):
        try:
            ...
            print("The given element is not a valid input!")
    ...
    def _parse_action(self, input: str):
        ...
        if not pos_x or pos_x > self.minefield.width: return None

        pos_y = self._parse_uinteger(elements[2])
        if not pos_y or pos_y > self.minefield.height: return None
